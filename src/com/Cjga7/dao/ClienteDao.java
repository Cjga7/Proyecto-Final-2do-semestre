package com.Cjga7.dao;

import com.Cjga7.model.Cliente;
import com.Cjga7.util.ConectorBD;
...
public class ClienteDao {
    ...
    public void addCliente(Cliente cliente){
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO cliente (nif, nombre, ciudad, direccion, telefono) VALUES (?, ?, ?, ?, ?)");
